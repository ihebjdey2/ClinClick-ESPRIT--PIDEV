   ...
   public EditProfile(Form previous,User u) {
        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                if (tfnom.getText().equals("")||(tfemail.getText().equals("")))
                {
                ...
                {
                    try {
                            User userr = new User(u.getId(),tfemail.getText(),tfnom.getText(),tfpw.getText());
                           if( ServiceUser.getInstance().editUser(userr)){
                               
                                   Dialog.show("Success","Utilisateur modifier avec success",new Command("OK"));
